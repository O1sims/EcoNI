...
var KeysAndValues = /** @class */ (function (_super) {
    ...
    KeysAndValues.prototype.render = function () {
        ...
        return (h("div", { className: "uirTranVis_keysAndValues" },
            ...
            showGroupToggle && !!groupedTuples.length && (h("a", { href: "javascript:void(0)", onClick: function () { return _this.setState({ collapseFalsy: !isCollapsed }); }, className: "uirTranVis_keyValue" },
                ...
                " parameter values")),
            (!showGroupToggle || !this.state.collapseFalsy) && (groupedTuples.map(function (tuple) { return (h(KeyValueRow, { key: tuple.key, tuple: tuple, classes: classes, modalTitle: modalTitle })); }))));
    };
